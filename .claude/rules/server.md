...
- APOC is an optional edge-writer optimization and must retain the non-APOC fallback. Shortest and weighted path queries use native/bounded Cypher and must not require APOC.
