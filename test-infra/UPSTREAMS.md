...
All Python transitive entry points used by authored services are exact-version
pins in their adjacent `requirements.txt` files.
...
| Ollama runtime model | upstream registry name `qwen2:0.5b`; exact singleton inventory is enforced after pull |
