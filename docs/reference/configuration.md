...
The server accepts every structurally valid ingest-v1 artifact whose registered
...
Back up and restore PostgreSQL and Neo4j together. Storage binding V1 and ingest
V1 require freshly initialized paired stores. This development baseline has no
in-place upgrade or artifact-conversion path: recreate both database volumes
together, restart, and recollect.
