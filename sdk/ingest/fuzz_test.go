...
func FuzzIngestData(f *testing.F) {
	...
	f.Add([]byte(`{"meta":{"version":2,"type":"agenthound-ingest","collector":"mcp","collector_version":"0.1.0","timestamp":"2026-04-06T10:30:00Z","scan_id":"scan-001","collection":{"state":"complete","coverage_keys":["mcp:target:sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"],"outcomes":[{"collector":"mcp","coverage_key":"mcp:target:sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","target":"https://mcp.example","method":"enumerate","state":"complete"}]},"ruleset":{"digest":"sha256:rules","load_state":"complete","authenticity":"unverified"},"identity_schemes":[{"entity_kind":"MCPServer","transport":"stdio","scheme":"mcp_stdio_v2_ordered","version":2}]},"graph":{"nodes":[],"edges":[]}}`))
	f.Add([]byte(`{}`))
	f.Add([]byte(`null`))
	f.Add([]byte(``))
