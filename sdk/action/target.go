...
// Enumerate, Loot, Extract, Poison, Implant). It is deliberately flat: Kind
// discriminates and Meta carries discovery hints. Adding typed target
// sub-structures would be an explicit future API change, not an implied v1
// milestone.
type Target struct {
