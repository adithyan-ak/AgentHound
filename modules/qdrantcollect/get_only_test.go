...
// no state-mutating requests. The Qdrant Collector is PURE GET — its
...
//
// Mirrors modules/mlflowcollect/get_only_test.go and
// modules/ollamacollect/get_only_test.go.
