...
var campaignEvidencePropertyKeys = map[string]bool{
	...
	campaign.PropServerKind: true, campaign.PropServerIdentityID: true,
	campaign.PropServiceScope: true, campaign.PropServiceScopeID: true,
	campaign.PropResourceID:   true,
